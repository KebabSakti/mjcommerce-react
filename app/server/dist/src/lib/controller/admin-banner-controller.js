...
const admin_banner_repository_1 = __importDefault(require("../repository/admin-banner-repository"));
const adminBannerRepository = new admin_banner_repository_1.default();
...
exports.default = AdminBannerController;
